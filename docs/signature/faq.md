...
- There is a maximum amount of letters dropped by minute and this maximum amount increases as the player online increases (and decreases when the online decreases)
...
- No expoff command, delevel by pvp
...
<form id="taxCalculator">
    <div class="tax-grid">
        ...
        <div class="tax-cell" id="castleTaxSection">
            ...
            <input type="number" id="castleTax" min="0" max="100" step="0.01" value="0" placeholder="Enter tax rate">
        </div>
    </div>
    <figure>
...
function handleCastleChange(castle) {
    const townSelect = document.getElementById('town');
...
[![image.png](https://i.postimg.cc/Qts3g5VT/image.png)](https://postimg.cc/xkshnXvf)
