...
- ### :octicons-sun-16: __Tasks__{ .lg .middle }

    There are different type of missions with more than 1,000 variations:

    - Daily: dynamically chosen every day, different for all players
    - Weekly: dynamically chosen every day, different for all players
